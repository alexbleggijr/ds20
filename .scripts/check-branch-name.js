...
const branchPattern =
  /^(root|angular-material|icons|interactions|ionic-5|ionic-6|ionic-7|ionic-8|shared|tokens|utilities|web-components)+\/(feat|fix|docs|style|refactor|test|build|ci|chore)\/[a-z0-9\-]+$/;
